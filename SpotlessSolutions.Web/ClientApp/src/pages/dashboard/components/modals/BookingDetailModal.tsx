            ...
            <Dialog open={Boolean(prop.data)} onClose={prop.handleClose} maxWidth="md" fullWidth={true}>
              <div className="modal-container">
                <div className="modal-header">
                  <h2>{prop.data?.mainService.service.name}</h2>
                  <button type='button'>
                ...
                <div className="modal-contents">
                  <div className='modal-information'>
                      ...
                      <span className="ml-12">
                                {
                                  Intl
                                    ...
                                    .format(new Date(prop.data.schedule))
                                }
                                </span>
                    </p>
                    <p>
                    ...
                    <p>
                      Add-ons:&nbsp;
                      <span className="ml-5">
                                    {prop.data?.addons.map(x => x.service.name).join(', ')}
                                </span>
                    </p>
                    <p className="mt-8">
                      Total: <span className="ml-12">₱ {prop.data?.totalPrice}</span>
                    </p>
                  </div>
