      ...
      <div className="bg-[#05132F] text-white p-4 md:p-10 flex flex-col md:flex-row justify-between">
        <div className="flex items-center mb-4 md:mb-0">
          ...
          <div>
            ...
            <p className="sm:text-sm lg:text-lg font-bold">0917 129 2231</p>
          </div>
        </div>
        ...
        <div className="flex items-center mb-4 md:mb-0">
          ...
          <div>
            ...
            <a
              ...
              className="sm:text-sm lg:text-lg font-bold cursor-pointer"
            >
        ...
        <div className="flex items-center mb-4 md:mb-0">
          ...
          >
            ...
            <div>
              ...
              <p className="sm:text-sm lg:text-lg font-bold">Facebook</p>
            </div>
          </a>
        </div>
      </div>
